...
class clsProveedor
{
	...
	{
		$sql = "INSERT INTO persona(id,nombres,apellidos,dni,ruc,razon_social,tipopersona,direccion,telefono,tipocliente,tipoproveedor,estado) VALUES(null,:nombres,:apellidos,:dni,:ruc,:razon_social,:tipopersona,:direccion,:telefono,'N','S','N')";
		global $cnx;
	...
	function consultar($nombre)
	{
		$sql = "SELECT id,nombres,apellidos,dni,ruc,razon_social,tipopersona,direccion,telefono,estado 
				FROM persona WHERE estado <> 'E' AND tipoproveedor = 'S' ";
		$parametros = array();
		if($nombre!=''){
