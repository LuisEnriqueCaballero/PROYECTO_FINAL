...
<script type="text/javascript">
    ...
    ViewModal('presentacion/adminProveedorselect.php?accion=REGISTRAR','divlibre','Seleccionar Proveedor');
  }
  function listarproductos() {
    ViewModal('presentacion/adminProductoselect.php?accion=REGISTRAR','divlibre','Seleccionar Producto');
  }
