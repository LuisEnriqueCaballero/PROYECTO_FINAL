	...
	<tbody>
		<?php
			...
			while($dato = $data->fetch(PDO::FETCH_NAMED)){ 
				...
				$datastock = $objproducto->consultarStockProductoById($dato['id']);
		...
		?>
			<tr class="<?php echo $class;?>">
				...
				<td><?php echo $dato['nombre']; ?><input type="hidden" name="nombreproducto<?php echo $i; ?>" id="nombreproducto<?php echo $i; ?>" value="<?php echo $dato['nombre']; ?>"></td>
				<td><input type="text" name="preciocompra<?php echo $i; ?>" id="preciocompra<?php echo $i; ?>" value="<?php echo $dato['preciocompra']; ?>" size="3"></td>
